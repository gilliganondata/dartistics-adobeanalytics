...
This example pulls the top 10 pages for the last thirty days, _for visits where the entry page included the word "excel"_.*  We'll do this by referencing a segment that was built in the Adobe Analytics web UI.
...
aa_data <- QueueRanked(rsid,
                       ...
                       elements = "page",
                       top = 10,
                       segment.id = "s300005730_59d38b213f1e920264d17ecd")
